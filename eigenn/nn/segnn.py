...
class EmbeddingLayer(ModuleIrreps, torch.nn.Module):
    ...
    def __init__(
        ...
        """
        Node embedding (self-connection) layers.
...
# TODO add resnet back, Define a point conv class, as in tfn, and share by all models
    ...
    def __init__(
        ...
        *,
        ...
        self.message_activation = ActivationLayer(
            node_feats_irreps_in, edge_attrs_irreps, conv_layer_irreps
        )
        ...
        self.update_activation = ActivationLayer(
            irreps_after_message_act, node_attrs_irreps, conv_layer_irreps
        )
